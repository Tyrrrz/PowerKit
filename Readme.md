...
> [!IMPORTANT]
> This package is compatible with .NET Standard 2.0+ and .NET Framework 3.5+, however most older targets will require additionally installing [**PolyShim**](https://github.com/Tyrrrz/PolyShim) to bridge missing APIs and compiler features.
